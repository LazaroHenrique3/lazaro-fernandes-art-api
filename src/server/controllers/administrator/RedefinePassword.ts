...
interface IBodyProps extends Omit<IAdministratorRedefinePassword, 'verification_token_expiration'> { }
...
export const redefinePassword = async (req: Request<{}, {}, IBodyProps>, res: Response) => {
    ...
    const result = await AdministratorProvider.redefinePassword(req.body)
